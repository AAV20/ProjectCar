...
<div class="card_main_empty_div2">
    <img class="cmed2_img" src="./images/smile.png" alt="Empty Card">
</div>
...
<button class="cmed4button"><a href="./index.html">Перейти в каталог</a></button>
</div>
</div>`;
} else {
...
>
<button class='shop'><img src="./images/bucket.svg" alt="" /></button>
</div> `;
